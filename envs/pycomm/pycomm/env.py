...
class DynamicEnv:
    def __init__(
        ...
        config = {'job':job,'store_keep':store_keep,'channel_type':channel_type,'antenna_type':antenna_type,
                  ...
                  'handover_interval':handover_interval,'output':output}
        self.config = config
...
class CoverageEnv:
    ...
    self,channel_type: int = 3, #信道类型
        ...
        self.optimize_client = SimClient("localhost:51402",optimize_type = 2,config=self.config)
        self._timestep = 0
...
class ConserveEnv:
    ...
    self,channel_type: int = 1, #信道类型
        ...
        self.optimize_client = SimClient("localhost:51402",optimize_type = 3,config=self.config)
        self._timestep = 0
