...
class ACTLayer(nn.Module):
    ...
    :param inputs_dim: (int) dimension of network input.  隐藏层大小
    ...
    def __init__(self, action_space, inputs_dim, use_orthogonal, gain):
        ...
        if action_space.__class__.__name__ == "Discrete":
            action_dim = action_space.n - 2
            self.action_out = Categorical(inputs_dim, action_dim, use_orthogonal, gain) # inputs_dim隐藏层大小，action_dim有几个动作
