...
class UNet(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int):
        ...
        self.up_sample = nn.ModuleList([UpSample(1024, 512, output_padding=(0, 1)), UpSample(512, 256, output_padding=(0, 1)),
                                        UpSample(256, 128, output_padding=(0, 0)), UpSample(128, 64, output_padding=(1, 0))])
