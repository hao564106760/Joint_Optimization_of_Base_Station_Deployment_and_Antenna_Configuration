...
from algorithms.algorithm.r_actor_critic2 import R_Actor, R_Critic
    ...
    def __init__(self, args, obs_space, cent_obs_space, act_space, device=torch.device("cpu")):
        ...
        if self.use_pretrain_model == True:
            self.actor.load_state_dict(
                torch.load("/data7/liuhaoqiang/results_4/MyEnv/MyEnv/mappo/check/run1/models/actor2.pt"))
            self.critic.load_state_dict(
                torch.load("/data7/liuhaoqiang/results_4/MyEnv/MyEnv/mappo/check/run1/models/critic2.pt"))
            self.Unet.load_state_dict(
                torch.load("/data7/liuhaoqiang/results_4/MyEnv/MyEnv/mappo/check/run1/models/Unet2.pt"))
            print('导入模型成功')
        ...
        self.actor_optimizer = torch.optim.Adam(
            ...
            lr=self.lr/5, eps=self.opti_eps,
